...
public:
    ...
    virtual void RenderSceneCB()
    {
        ...
        m_pEffect->SetMatSpecularIntensity(coeffLightValue); //1.0f
        m_pEffect->SetMatSpecularPower(32); //32
        ///
    ...
    virtual void KeyboardCB(unsigned char Key, int x, int y)
    {
        switch (Key) {
            ...
            case 'p':
                if (coeffLight) {
                    coeffLight = false;
                    coeffLightValue = 0.0f;
                }
                else {
                    coeffLight = true;
                    coeffLightValue = 1.0f;
                }
                break;
        }
    }
...
private:
    ...
    bool coeffLight = true;
    float coeffLightValue = 1.0f;
};
